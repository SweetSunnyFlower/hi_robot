 ...
 * createTime : 2020/12/9 3:54 下午
 * description :
 */

class Gring_Hi_Parser_Parser {
    ...
    protected function parseTag() {
        ...
        while (isset($this->html[$pos])) {
            ...
            if (($pos_ord >= static::$a_ord && $pos_ord <= static::$z_ord) || (!empty($tagName) && is_numeric(
                        $this->html[$pos]
                    ))) {
        ...
        while (isset($this->html[$pos + 1])) {
            ...
            $pos_ord = ord(strtolower($this->html[$pos]));
            if (($pos_ord >= static::$a_ord && $pos_ord <= static::$z_ord) || in_array(
                    $pos_ord,
                    static::$special_ords
                )) {
                // attribute name
